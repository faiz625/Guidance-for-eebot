...
PTH_C_INT       EQU   $CA                       ; ""
PTH_D_INT       EQU   $CA                       ; ""
PTH_E_INT       EQU   $98                       ; If SENSOR_LINE < PTH_E_INT robot must shift right
PTH_F_INT       EQU   $85                       ; If SENSOR_LINE > PTH_F_INT robot must shift left

INC_DIS         EQU   300                       ; INCREMENT distance
FWD_DIS         EQU   2000                      ; FORWARD distance
REV_DIS         EQU   1000                      ; REVERSE distance
STR_DIS         EQU   1400                      ; STRAIGHT distance
TRN_DIS         EQU   10000                     ; TURN distance
UTRN_DIS        EQU   11000                     ; U-TURN distance
;--------------------------------------------------------------------------------------------
